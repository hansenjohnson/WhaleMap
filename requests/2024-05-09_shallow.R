...
REQUEST_NAME = '2024-05-09_SHALLOW'
...
START_DATE = "2024-05-01" # enter as follows: "2018-04-01" (set to NA to not use)
END_DATE = "2024-06-30" # enter as follows: "2018-04-01" (set to NA to not use)
...
DATASOURCES = c("WhaleMap", "WhaleInsight", "RWSAS") # choose from: c("WhaleMap", "WhaleInsight", "RWSAS", "NARWC")
