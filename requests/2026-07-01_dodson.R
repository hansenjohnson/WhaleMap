...
# Request by Tara Dodson to support St Johns County Coastal Management Planning
...
REQUEST_NAME = '2026-07-01_DODSON'
...
START_DATE = "2024-11-01" # enter as follows: "2018-04-01" (set to NA to not use)
END_DATE = "2026-07-01" # enter as follows: "2018-04-01" (set to NA to not use)
