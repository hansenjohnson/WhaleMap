...
# Request by Crystal Franco to analyze data from Jeffreys Ledge Aggregation
...
REQUEST_NAME = '2026-04-03_FRANCO'

# include effort (TRUE), or only observations (FALSE)

INCLUDE_EFFORT = TRUE # enter TRUE or FALSE
...
END_DATE = "2026-04-03" # enter as follows: "2018-04-01" (set to NA to not use)
