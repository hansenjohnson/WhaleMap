...
# Request by Ann Zoidis to inform South Atlantic Regional Dredging
...
REQUEST_NAME = '2026-04-22_ZOIDIS'
...
START_DATE = "2020-01-01" # enter as follows: "2018-04-01" (set to NA to not use)
END_DATE = "2026-04-22" # enter as follows: "2018-04-01" (set to NA to not use)
...
PLATFORMS = c("plane", "vessel", "opportunistic") # choose from: c("buoy", "slocum", "plane", "vessel", "rpas")
