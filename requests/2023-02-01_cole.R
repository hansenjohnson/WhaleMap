...
# Request from Alexandra Cole (Canadian Wildlife Federation) for all 
# definite visual and acoustic detections in Canada 2018-2021
...
US_only = FALSE # enter TRUE or FALSE
CAN_only = TRUE # enter TRUE or FALSE
...
START_DATE = "2018-01-01" # enter as follows: "2018-04-01" (set to NA to not use)
END_DATE = "2021-12-31" # enter as follows: "2018-04-01" (set to NA to not use)
...
SCORES = c("definite visual", "definite acoustic") # choose from: c("definite visual", "definite acoustic", "possible visual", "possible acoustic")
...
DATASOURCES = c("WhaleMap", "RWSAS", "WhaleInsight") # choose from: c("WhaleMap", "WhaleInsight", "RWSAS", "NARWC")
