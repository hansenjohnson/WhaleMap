## proc_2020_neaq ##
# process and save all 2020 neaq/cwi sightings and tracklines

# user input --------------------------------------------------------------

# directory to look for files
data_dir = 'data/raw/2020_neaq/'
...
# save
saveRDS(tracks, paste0(output_dir, '2020_neaq_tracks.rds'))
...
# save
saveRDS(sightings, paste0(output_dir, '2020_neaq_sightings.rds'))
