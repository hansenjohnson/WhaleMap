## proc_2020_dfo_cessna2_tracks ##
# Process gps data from DFO cessna 2 survey plane

# user input --------------------------------------------------------------

# data directory
data_dir = 'data/raw/2020_whalemapdata/DFO_Cessna2/'

# output file name
ofile = '2020_dfo_cessna2_tracks.rds'
