...
data_dir = 'data/raw/2022_neaq_sne/'
...
# save
saveRDS(tracks, paste0(output_dir, '2022_neaq_sne_tracks.rds'))
...
# save
saveRDS(sightings, paste0(output_dir, '2022_neaq_sne_sightings.rds'))
