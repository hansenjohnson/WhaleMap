## proc_2021_noaa_twin_otter ##
# Process gps and sightings data from NOAA Twin Otter survey plane

# user input --------------------------------------------------------------

# data directory
data_dir = 'data/raw/2021_noaa_twin_otter/'

# output file names
track_file = '2021_noaa_twin_otter_tracks.rds'
sighting_file = '2021_noaa_twin_otter_sightings.rds'
