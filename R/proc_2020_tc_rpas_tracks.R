## proc_2020_tc_rpas_tracks ##
# Process gps data from TC RPAS survey

# user input --------------------------------------------------------------

# data directory
data_dir = 'data/raw/2020_whalemapdata/TC_RPAS/'

# output file name
ofile = 'data/interim/2020_tc_rpas_tracks.rds'
...
flist = list.files(data_dir, pattern = '*.*line.kml$', full.names = T, recursive = T)
