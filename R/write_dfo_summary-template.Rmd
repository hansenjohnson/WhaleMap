...
obs = subset_canadian(obs, bb_file = '../data/raw/gis/canadian_boundary/canadian_boundary.csv')
...
trk = subset_canadian(trk, bb_file = '../data/raw/gis/canadian_boundary/canadian_boundary.csv')
