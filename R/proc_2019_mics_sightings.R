## proc_2019_mics_sightings ##
# process 2018 MICS right whales sightings

# input -------------------------------------------------------------------

# sightings data file
data_file = 'data/raw/2019_mics/Right Whale MICS 2019.xlsx'

# output file name
out_file = 'data/interim/2019_mics_sightings.rds'
