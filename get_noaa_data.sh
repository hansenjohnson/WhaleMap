...
rclone sync drive:"2018 Canadian Right Whales/Photo Data Submission to the NARWC/NEFSC/Flights/" "2018_noaa_twin_otter/" --drive-formats csv --backup-dir backups -v --exclude *.JPG --exclude *.mp4
