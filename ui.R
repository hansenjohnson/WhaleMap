...
header <-  dashboardHeader(title = 'WhaleMap',
                           ...
                           dropdownMenu(
                             ...
                             notificationItem("Data Access",
                                              icon = icon('file', lib = 'glyphicon'),
                                              href = "https://whalemap.org/#data"),
    ...
    column(width = 3,
           ...
           tabBox(title = NULL, width = NULL,
                  ...
                  tabPanel(title = 'Layers',
                           ...
                           checkboxInput("virginia_rfi", value = F,
                                         label = span("Virginia Mineral RFI", 
                                                      tags$a(icon("info-sign", lib = "glyphicon"), 
                                                             target="_blank",
                                                             href = "https://www.boem.gov/marine-minerals/critical-minerals/virginia-mineral-activities"))),
